...
function show_accounts($instance_url, $access_token) {
    ...
    <div class='container'><div class='table-responsive'><table class='table table-condensed table-hover'><td>ID</td><td>Name</td><td align='center'>Amount</td></table></div></div>";

    foreach ((array) $response['records'] as $record) {

        echo "<div class='container'><div class='table-responsive'><table class='table table-condensed table-hover'><td>".$record['Id'] ."</td><td>" . $record['Name'] . "</td><td align='center'>$" . $record['Amount'] . "</td></table></div></div>";
