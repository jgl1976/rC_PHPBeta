...
//////////////////////////////pagination/////////////////////////////////////////////////////////////////
        ...
        $theDiv .= "<tr><td width='25%'>".$record['Id']."</td><td width='25%'>".$record['rC_Giving__Lifetime_Amount__c']."</td><td width='25%'>".$record['rC_Giving__Is_Lifetime__c']."</td><td width='25%'><button value='edit'></button></td></tr>";
    }   
    $theDiv .= "</table></div></div>";
    }
